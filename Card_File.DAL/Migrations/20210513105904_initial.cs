        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_TextMaterials_Categories_CategoryId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Comments_TextMaterials_TextMaterialId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    TextNaterialId = table.Column<int>(type: "int", nullable: false),
                    Title = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Text = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    TextMaterialId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_MaterialParts", x => x.Id);
                    table.ForeignKey(
                        name: "FK_MaterialParts_TextMaterials_TextMaterialId",
                        column: x => x.TextMaterialId,
                        principalTable: "TextMaterials",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TagTextMaterial_TextMaterialsId",
                table: "TagTextMaterial",
                column: "TextMaterialsId");

            migrationBuilder.CreateIndex(
                name: "IX_TextMaterials_CategoryId",
                table: "TextMaterials",
                column: "CategoryId");
